...
export const getRecipes = () => (dispatch) => {
    ...
    axios("https://recipes-production-bafa.up.railway.app/recipes")
...
export const searchRecipeName = (recipe) => (dispatch) => {
    ...
    axios(`https://recipes-production-bafa.up.railway.app/recipes?name=${recipe}`)
...
export const searchRecipeId = (id) => (dispatch) => {
    ...
    axios(`https://recipes-production-bafa.up.railway.app/recipes/${id}`)
...
export const getAllDiets = () => (dispatch) => {
    axios("https://recipes-production-bafa.up.railway.app/types")
    ...
    return async () => {
        try {
            await axios.post(
                ...
                "https://recipes-production-bafa.up.railway.app/createrecipe",
